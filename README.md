...
- `GET, URL: /, Body: NONE, Response {id, text, done}[]`
- `POST, URL: /, Body: {text, done}, Response: {id, text, done}`
- `PUT, URL: /{id}, Body: {id, text, done}, Response: {id, text, done}`
- `PATCH, URL: /{id}, Body: {done}, Response: {id, text, done}`
- `DELETE, URL: /{id}, Body: NONE, Response: id`
